...
export const DetailHeader = ({ title = 'Заголовок', challengeId }: DetailHeaderProps) => {
  ...
  return (
    <Group h={64} px={24} gap={12} align="center" style={{ borderBottom: '1px solid var(--mantine-color-dark-6)' }}>
      <ActionIcon variant="subtle" size="lg" onClick={() => router.back()} aria-label="Go back">
